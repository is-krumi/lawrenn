  ...
  try {
    ...
    const event = await calendar.events.insert({
      ...
      requestBody: {
        ...
        conferenceData: {
          createRequest: {
            requestId:  `rennops-demo-${Date.now()}`,
    ...
    await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to:      email,
        subject: `Your RennOps demo is confirmed — ${slotDisplay}`,
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto;">
            ...
            <div style="padding: 40px;">
              ...
              <p style="color: #6B7280; font-size: 15px; line-height: 1.7; margin-bottom: 32px;">
                Hi ${name}, we're looking forward to showing you RennOps.
              </p>
              ...
              <div style="background: #F0FAFE; border: 1.5px solid rgba(12,192,223,0.25); border-radius: 10px; padding: 20px 24px; margin-bottom: 32px;">
                <p style="font-size: 11px; font-weight: 700; color: #0cc0df; text-transform: uppercase; letter-spacing: 0.1em; margin: 0 0 6px;">Your demo details</p>
                <p style="font-size: 20px; font-weight: 700; color: #0D1B2A; margin: 0 0 4px;">${slotDisplay} ET</p>
                <p style="font-size: 13px; color: #6B7280; margin: 0;">30 minutes · Google Meet</p>
              </div>

              <a href="${meetLink}" style="display: inline-block; padding: 14px 28px; background: #0cc0df; border-radius: 8px; color: white; font-weight: 700; font-size: 15px; text-decoration: none; margin-bottom: 32px;">
                Join Google Meet
              </a>

              <p style="color: #6B7280; font-size: 14px; line-height: 1.7;">
                During the demo we'll show you how RennOps answers every call, books every job, and follows up on every quote — automatically.
              </p>
            ...
            <div style="padding: 24px 40px; border-top: 1px solid rgba(0,0,0,0.06);">
              <p style="font-size: 12px; color: #9CA3AF; margin: 0;">© 2026 RennOps. All rights reserved.</p>
            </div>
          </div>
        `,
      }),
